...
/* USER CODE BEGIN PV */
VL53L5CX_Configuration Dev;  // Sensor configuration structure
VL53L5CX_ResultsData Results;  // Results from the sensor
...
void get_data_by_polling(VL53L5CX_Configuration *p_dev);  // Function prototype
...
//  MX_BlueNRG_2_Init();
  ...
  Dev.platform.address = VL53L5CX_DEFAULT_I2C_ADDRESS;
      ...
      if(!isAlive) {
          printf("VL53L5CX not detected at address 0x%x\n", Dev.platform.address);
          return 255;  // Return an error code if the sensor isn't found
      }

      printf("VL53L5CX sensor initializing...\n");
      ...
      status = vl53l5cx_set_ranging_mode(&Dev, VL53L5CX_RANGING_MODE_CONTINUOUS);  // Set continuous ranging mode
      printf("Ranging started\n");

      /* Start ranging */
      status = vl53l5cx_start_ranging(&Dev);

      // Main loop (choose polling or interrupt)
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED4_Pin|LED3_Pin|GPIO_PIN_0|BLNRG_RST_Pin
                          |NUCLEO_LED_Pin|RST_Pin|LED2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED4_Pin LED3_Pin PC0 BLNRG_RST_Pin
                           NUCLEO_LED_Pin RST_Pin LED2_Pin */
  GPIO_InitStruct.Pin = LED4_Pin|LED3_Pin|GPIO_PIN_0|BLNRG_RST_Pin
                          |NUCLEO_LED_Pin|RST_Pin|LED2_Pin;
  ...
  /*Configure GPIO pins : BSP_button_Pin INT_ENCODER1_Pin INT_ENCODER2_Pin */
  GPIO_InitStruct.Pin = BSP_button_Pin|INT_ENCODER1_Pin|INT_ENCODER2_Pin;
